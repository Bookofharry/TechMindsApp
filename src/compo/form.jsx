        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
            <div>
              ...
              <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">info@techmindsacademy.org</p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">
                G5 Plaza Sabon Gari, Bwari Abuja.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+234 (814) 732-8332</p>
            </div>
          </div>
